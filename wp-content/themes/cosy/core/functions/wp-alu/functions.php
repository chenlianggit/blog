...
function alu_get_wpsmiliestrans() {
    ...
    foreach ($wpsmilies as $alt => $src_path) {
        ...
        $output .= '<a class="add-smily" data-action="addSmily" data-smilies="' . $alt . '"><img class="wp-smiley" src="' . get_template_directory_uri() . '/core/functions/wp-alu/static/img/' . $src_path .'" /></a>';
    }
    return $output;
}
