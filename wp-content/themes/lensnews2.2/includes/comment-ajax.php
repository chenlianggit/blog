	...
	<li <?php comment_class(); ?>>
		<article id="comment-<?php comment_ID(); ?>" class="comment_body">
            ...
            <div class="comment_info">
                <span class="author_name"><?php global $salong; if ($salong['switch_link_go']) {commentauthor();} else {comment_author_link();} ?></span><?php _e( '发布于：', 'salong' ); ?>&nbsp;<time class="datetime"><?php echo get_comment_date().'&nbsp;'.get_comment_time() ?></time>
            </div>
