...
/*分类列表1*/
$cat_tax_name1 = $salong['cat1_taxonomy_name1'];
if($cat_tax_name1 == 'post'){
    $post_type1 = 'post';
    $cat_tax1  = 'category';
    $tag_tax1  = 'post_tag';
    $category1  = $salong[ 'post_cat1_list1'];
    $tag1       = $salong[ 'post_cat1_tag1'];
}else if($cat_tax_name1 == 'gallery'){
    $post_type1 = 'gallery';
    $cat_tax1  = 'gallery-cat';
    $tag_tax1  = 'gallery-tag';
    $category1  = $salong[ 'gallery_cat1_list1'];
    $tag1       = $salong[ 'gallery_cat1_tag1'];
}else if($cat_tax_name1 == 'video'){
    $post_type1 = 'video';
    $cat_tax1  = 'video-cat';
    $tag_tax1  = 'video-tag';
    $category1  = $salong[ 'video_cat1_list1'];
    $tag1       = $salong[ 'video_cat1_tag1'];
}

/*分类列表2*/
$cat_tax_name2 = $salong['cat1_taxonomy_name2'];
if($cat_tax_name2 == 'post'){
    $post_type2 = 'post';
    $cat_tax2  = 'category';
    $tag_tax2  = 'post_tag';
    $category2  = $salong[ 'post_cat1_list2'];
    $tag2       = $salong[ 'post_cat1_tag2'];
}else if($cat_tax_name2 == 'gallery'){
    $post_type2 = 'gallery';
    $cat_tax2  = 'gallery-cat';
    $tag_tax2  = 'gallery-tag';
    $category2  = $salong[ 'gallery_cat1_list2'];
    $tag2       = $salong[ 'gallery_cat1_tag2'];
}else if($cat_tax_name2 == 'video'){
    $post_type2 = 'video';
    $cat_tax2  = 'video-cat';
    $tag_tax2  = 'video-tag';
    $category2  = $salong[ 'video_cat1_list2'];
    $tag2       = $salong[ 'video_cat1_tag2'];
}
    ...
    <section class="cat-wrap<?php if(!wp_is_mobile()) { ?> left<?php } ?>">
        ...
        <section class="box<?php triangle();wow(); ?>">
            ...
            <section class="cat1_list1">
                <ul class="layout_ul">
                    <?php $cat1count1=$salong[ 'cat1_count1']; $args=array( 'post_type'=> $post_type1,'posts_per_page' => $cat1count1,'ignore_sticky_posts' => 1,'tax_query' => array( array( 'taxonomy' => $cat_tax1, 'field' => 'id', 'terms' => $cat1list1 ))); $wp_query = new WP_Query( $args );if ( $wp_query->have_posts() ) : $count = 1; while ( $wp_query->have_posts() ) : $wp_query->the_post(); ?>
        ...
        <section class="box<?php triangle();wow(); ?>">
            ...
            <section class="cat1_list2">
                <ul class="layout_ul">
                    <?php $cat1count2=$salong[ 'cat1_count2']; $args=array( 'post_type'=> $post_type2,'posts_per_page' => $cat1count2,'ignore_sticky_posts' => 1,'tax_query' => array( array( 'taxonomy' => $cat_tax2, 'field' => 'id', 'terms' => $cat1list2 ))); $wp_query = new WP_Query( $args );if ( $wp_query->have_posts() ) : $count = 1; while ( $wp_query->have_posts() ) : $wp_query->the_post(); ?>
